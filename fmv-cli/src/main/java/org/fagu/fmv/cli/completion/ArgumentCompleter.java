...
public class ArgumentCompleter implements Completer {
	...
	public int complete(final String buffer, final int cursor, final List<CharSequence> candidates) {
		...
		// System.out.println("completer: " + completer);
		...
		// System.out.println("complete-end(" + buffer + ", " + cursor + ", " + candidates + ") : " + pos);
	...
	public abstract static class AbstractArgumentDelimiter implements ArgumentDelimiter {
		 ...
		 * @return true if the character at the specified position in the given buffer is an escape character and the
		 *         character immediately preceding it is not an escape character.
		 */
