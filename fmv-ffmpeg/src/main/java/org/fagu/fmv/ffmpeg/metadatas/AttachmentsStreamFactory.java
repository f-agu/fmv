...
public class AttachmentsStreamFactory implements StreamFactory {
	 ...
	 * 
	 */
	public AttachmentsStreamFactory() {}

	/**
	 * @see org.fagu.fmv.ffmpeg.metadatas.StreamFactory#create(NavigableMap,
	 *      org.fagu.fmv.ffmpeg.metadatas.MovieMetadatas)
	 */
	@Override
	public Stream create(NavigableMap<String, Object> map, MovieMetadatas movieMetadatas) {
